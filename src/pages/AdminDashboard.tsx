...
export const AdminDashboard: React.FC = () => {
    ...
    if (isLoading) {
        return <Layout><div className="p-12 text-center">Loading applications...</div></Layout>;
    }
                            ...
                            applications.map((app) => (
                                <Card key={app.id} className="p-6">
                                    <div className="flex justify-between items-start mb-4">
                                        <div>
                                            <h3 className="font-bold text-lg text-secondary-900">{app.fullName || app.name}</h3>
                                    ...
                                    <div className="flex gap-3 justify-end">
                                        <Button variant="outline" size="sm" onClick={() => handleReject(app.id)} className="text-red-600 hover:text-red-700">Reject</Button>
                                        <Button size="sm" onClick={() => handleApprove(app.id)}>Approve Teacher</Button>
                                    </div>
                                </Card>
                            ))
                        )}
